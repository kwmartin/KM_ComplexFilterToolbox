...
p = 2*pi*[-0.35 -0.2 -0.15 -0.1 -0.05 0.16 0.18 0.25 0.35]; % initial guess at moveable finite loss poles
px = [0.0]; % fixed pole
...
print('../examples/Figures/dig_fltr_2_8_1/dig_fltr_2_10_1_mcbq','-dpng');
...
cscdHndl = gcf;
print('../examples/Figures/dig_fltr_2_8_1','-dpdf');
print('../examples/Figures/dig_fltr_2_8_1/dig_fltr_2_10_1_mc','-dpng');
toc

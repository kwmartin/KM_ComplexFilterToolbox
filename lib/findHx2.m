...
KKz = Kz*Kz_;
s1 = e_^2*KKz;
f1 = polyClass(s1.z{1}, s1.k);
p1 = polyClass(s1.p{1}, 1);
nh = f1 + p1; % This addition of polynomials uses Muller's algorithm for accuracy
HHz = zpk(nh.rts,p1.rts,1);
zhh1 = sort(HHz.z{1});

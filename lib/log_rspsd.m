function [hdb h] = log_rspsd(sys,s)
% This is a program for calculating the log10 response of a zpk discrete-time system.
...
h = exp(hlg);
hdb = 20*log10(abs(h)); % convert log2 to log10 % Convert to log10

...
p = 2*pi*[-0.35 -0.3 -0.25 -0.15 -0.1 0.25 0.35]; % initial guess at moveable finite loss poles
...
print('../examples/Figures/dig_fltr_2_7_1/dig_fltr_2_7_1_mcbq','-dpng');
hndl1 = figure('Position',[800 100 600 600]);
runMcCscd(cscdFltr, wpHz, 1e-5, 0, 100, [-240, 10], 'r');
cscdFltr2 = mkCscdFltrD2(H, wp);
plotSimCscd(cscdFltr2, wpHz, ws, -240, 0, 'b');
runMcCscd(cscdFltr2, wpHz, 1e-5, 0, 100, [-240, 10], 'b');
drawnow;
cscdHndl = gcf;
printRasterPdf(cscdHndl, '../examples/Figures/dig_fltr_2_7_1');

function Hz = place_polesdLP5(H,wp,fsb)
%   Hz = place_polesdLP5(H,wp,ws) is a program for placing loss poles
%   to equalize stop-band minima. The specifications need not be constant
%   or symmetric.
%
...
if nargin == 2
    ...
    fsb = sort(x2w(wy2, 2*tan(wt1/2)))/(2*pi);
    Hy2 =  z2ySbTrnsf1(H,fsb);
elseif nargin == 3
    Hy2 =  z2ySbTrnsf1(H,fsb); 
else

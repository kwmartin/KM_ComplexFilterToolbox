function H4 = equiGdDigital_scld(p,px,ni,wp,ws,as,Ap,deltGD, useWs)
%   [_scld copy of equiGdDigital.m - calls adaptP2_scld; see ScldGD.md section 11]
...
%
    ...
    % adaptP3. adaptP2_scld is far better for this case (max|pole|=1.14, only
    ...
    % matching adaptP2_scld/adaptP3 comment for the other call site with the

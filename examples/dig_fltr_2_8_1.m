...
cscdFltr = mkCscdFltrD(H, fpHz);
plotSimCscd(cscdFltr, fpHz, ws, -300, 0, 'b');
tic
drawnow;
cscdHndl = gcf;
% print('../examples/Figures/dig_fltr_2_8_1','-dpdf');
print('../examples/Figures/dig_fltr_2_8_1/dig_fltr_2_9_1_mcbq','-dpng');
hndl1 = figure('Position',[800 100 600 600]);
runMcCscd(cscdFltr, fpHz, 1e-5, 0, 100, [-280, 10], 'r');
cscdFltr2 = mkCscdFltrD2(H, wp);
plotSimCscd(cscdFltr2, fpHz, ws, -280, 0, 'b');

function H2 = dsgnDigitalFltrX_scld(p,px,ni,wp,ws,as,Ap,type,Ordr)
%   [_scld copy of dsgnDigitalFltr.m - calls dsgnEquiRplGDX_scld]
% H2 = dsgnDigitalFltrX_scld(p,px,ni,wp,ws,as,Ap,type) design a discrete-time transfer function
...
%
  ...
  elseif strcmp(type, 'equiGDLsPls')
    tic
    deltGD = 0.25;
    [H2, p, px, wp, ws, as] = dsgnEquiRplGDX_scld(p,px,wp,ws,as,Ap,Ordr,sclFctr,shftFctr,deltGD);
    toc

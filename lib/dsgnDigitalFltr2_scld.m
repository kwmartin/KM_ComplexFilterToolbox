function H2 = dsgnDigitalFltr2_scld(p,px,ni,wp,ws,as,Ap,type,Ordr)
%   [_scld copy of dsgnDigitalFltr2.m - calls dsgnEquiRplGD_scld; equiGD type calls adaptP2_scld]
...
%
  ...
  elseif strcmp(type, 'equiGDLsPls')
    tic
    deltGD = 0.25;
    [H2, p, px, wp, ws, as] = dsgnEquiRplGD_scld(p,px,wp,ws,as,Ap,Ordr,sclFctr,shftFctr,deltGD);
    toc
